...
<div class="btn-group">
<?php
echo $this->FileManager->adminAction(__d('croogo', 'Upload here'), array('controller' => 'file_manager', 'action' => 'upload'), $path
);
echo $this->FileManager->adminAction(__d('croogo', 'Create directory'), array('controller' => 'file_manager', 'action' => 'create_directory'), $path
);
echo $this->FileManager->adminAction(__d('croogo', 'Create file'), array('controller' => 'file_manager', 'action' => 'create_file'), $path
);
?>
</div>
	<?php $this->end(); ?>
...
?>
				...
				foreach ($content['1'] as $file):
					...
					if ($icon == 'picture.png'):
						...
						$actions[] = $this->FileManager->link(__d('croogo', 'Edit'), array(
								'plugin' => 'file_manager',
